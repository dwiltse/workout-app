...
CREATE TABLE IF NOT EXISTS exercises (
  ...
  instructions TEXT,
  force VARCHAR(50), -- push, pull, static (from free-exercise-db)
  level VARCHAR(50), -- beginner, intermediate, expert
  mechanic VARCHAR(50), -- compound, isolation
  images TEXT[], -- array of image URLs
  is_custom BOOLEAN DEFAULT FALSE,
  source VARCHAR(50) DEFAULT 'manual', -- 'free-exercise-db' or 'manual'
...
-- Indexes for exercise search and filtering
